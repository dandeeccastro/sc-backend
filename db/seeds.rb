...
Talk.create([
  ...
  {
    location: Location.find_by(name: 'Auditório Salão Nobre'),
    type: Type.find_by(name: 'Mesa'),
    ...
    speaker: Speaker.find_by(name: 'Wilson Cardoso'),
  ...
  },
  {
    ...
    speaker: Speaker.find_by(name: 'Marina Menezes'),
    event: events.second,
  },
  {
    start_date: DateTime.current.change(hour: 15),
    end_date: DateTime.current.change(hour: 16),
    location: Location.find_by(name: 'Sala 619'),
    type: Type.find_by(name: 'Oficina'),
    title: 'Colagem',
    description: '',
    speaker: Speaker.find_by(name: 'Heloísa Vieira'),
    event: events.second,
  },
  {
    start_date: DateTime.current.change(hour: 15),
    end_date: DateTime.current.change(hour: 16),
    location: Location.find_by(name: 'Sala 626A'),
    type: Type.find_by(name: 'Oficina'),
    title: 'Anamorfose',
    description: '',
    speaker: Speaker.find_by(name: 'Gabriel Nogueira'),
    event: events.second,
  },
  {
    ...
    speaker: Speaker.find_by(name: 'Alexandre Palma'),
    event: events.second,
  },
  {
    start_date: 1.day.from_now.change(hour: 11),
    end_date: 1.day.from_now.change(hour: 12),
    location: Location.find_by(name: 'Sala 715'),
    type: Type.find_by(name: 'Oficina'),
    title: 'Design de Personagens',
    description:'',
    speaker: Speaker.find_by(name: 'Malu Rangel'),
    event: events.second,
  },
  {
    start_date: 1.day.from_now.change(hour: 11),
    end_date: 1.day.from_now.change(hour: 12),
    location: Location.find_by(name: 'Sala 711'),
    type: Type.find_by(name: 'Oficina'),
    title: 'Encadernação Artesanal',
    description:'',
    speaker: Speaker.find_by(name: 'Stella Feitosa'),
    event: events.second,
  },
  {
    start_date: 1.day.from_now.change(hour: 11),
    end_date: 1.day.from_now.change(hour: 12),
    location: Location.find_by(name: 'Sala 713'),
    type: Type.find_by(name: 'Oficina'),
    title: 'Padrões na madeira: entendendo a impressão em blocos indianos',
    description:'',
    speaker: Speaker.find_by(name: 'Manoel Pedro'),
    event: events.second,
  },
  {
  ...
  },
  {
    ...
    description: '',
    speaker: Speaker.find_by(name: 'Mateus Santos'),
    event: events.second,
  },
  {
    ...
    speaker: Speaker.find_by(name: 'Andrea Penteado'),
    event: events.second,
  },
  {
    ...
    speaker: Speaker.find_by(name: 'Doralice Duque'),
    event: events.second,
  },
  {
    ...
    speaker: Speaker.find_by(name: 'Gabrielle Carvalho e Jorge Marcelo Alves'),
    event: events.second,
  },
  {
    ...
    speaker: Speaker.find_or_create_by(name: 'Dr. Pierre Mothé Esteves', event: events.third),
    event: events.third,
  },
  {
    ...
    speaker: Speaker.find_or_create_by(name: 'Dra. Caroline Jaegger', event: events.third),
    event: events.third,
  },
  {
    ...
    speaker: Speaker.find_or_create_by(name: 'Dra. Ananda da Silva Antonio', event: events.third),
    event: events.third,
  },
  {
    ...
    speaker: Speaker.find_or_create_by(name: 'Luiara Rosa Cavalcanti', event: events.third),
    event: events.third,
  },
])
