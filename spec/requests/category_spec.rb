...
describe 'Category API' do
  path '/events/{slug}/category' do
    get 'listar categorias de evento' do
      tags 'Categorias'
    ...
    post 'criar categoria em evento' do
      tags 'Categorias'
      consumes 'application/json'
      produces 'application/json'
    end
  ...
  path '/events/{slug}/category/{id}' do
    get 'mostrar categoria de evento' do
      tags 'Categorias'
      consumes 'application/json'
      produces 'application/json'
    end
    
    put 'atualizar categoria em evento' do
      tags 'Categorias'
      consumes 'application/json'
      produces 'application/json'
    end

    delete 'remover categoria em evento' do
      tags 'Categorias'
      consumes 'application/json'
      produces 'application/json'
    end
