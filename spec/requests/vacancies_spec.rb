...
RSpec.describe "/vacancies", type: :request do
  ...
  # VacanciesController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get vacancies_url, headers: valid_headers, as: :json
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested vacancy" do
        vacancy = Vacancy.create! valid_attributes
        patch vacancy_url(vacancy),
              params: { vacancy: new_attributes }, headers: valid_headers, as: :json
        vacancy.reload
        skip("Add assertions for updated state")
      end

      it "renders a JSON response with the vacancy" do
        vacancy = Vacancy.create! valid_attributes
        patch vacancy_url(vacancy),
              params: { vacancy: new_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "renders a JSON response with errors for the vacancy" do
        vacancy = Vacancy.create! valid_attributes
        patch vacancy_url(vacancy),
              params: { vacancy: invalid_attributes }, headers: valid_headers, as: :json
        expect(response).to have_http_status(:unprocessable_entity)
  ...
  describe "DELETE /destroy" do
    it "destroys the requested vacancy" do
      vacancy = Vacancy.create! valid_attributes
      expect {
        delete vacancy_url(vacancy), headers: valid_headers, as: :json
      }.to change(Vacancy, :count).by(-1)
    end
  end
end
